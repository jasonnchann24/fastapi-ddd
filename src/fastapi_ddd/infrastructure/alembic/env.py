...
# get target_metadata from all installed domains

for domain in INSTALLED_DOMAINS:
    module = __import__(f"fastapi_ddd.domains.{domain}.models", fromlist=["*"])
    for item in dir(module):
        ...
        if isinstance(obj, type) and issubclass(obj, SQLModel):
            if target_metadata is None:
                ...
                target_metadata = target_metadata.union(obj.metadata)
